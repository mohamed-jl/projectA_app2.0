  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TOPerfo onChange={setTOPerfoData1} />
        <OffBlock onChange={setOffBlock1} />
        <WayPoints onChange={setWayPoints1} />
        <LDGData onChange={setLDGData1} />
        <ONBlock onChange={setOnBlock1} />
        <MARMData onChange={setMARMData1} />
        <Weight onChange={setWeightData1} />
        <TOData onChange={setTOData2} />
        <TOPerfo onChange={setTOPerfoData2} />
        <OffBlock onChange={setOffBlock2} />
        <WayPoints onChange={setWayPoints2} />
        <LDGData onChange={setLDGData2} />
