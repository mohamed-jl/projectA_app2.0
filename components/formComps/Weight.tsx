...
const Weight: React.FC<Props> = ({ onChange }) => {
  const [weightData, setWeightData] = useState<WeightData>({
    to: { oew: '', fuel: '', load: '', tWeight: '' },
    ldg: { oew: '', fuel: '', load: '', tWeight: '' },
    to2: { oew: '', fuel: '', load: '', tWeight: '' },
    ldg2: { oew: '', fuel: '', load: '', tWeight: '' },
  });
  ...
  const renderRow = (label: string, section: keyof WeightData) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        value={weightData[section].oew}
        onChangeText={val => handleChange(section, 'oew', val)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.inputCell}
        value={weightData[section].fuel}
        onChangeText={val => handleChange(section, 'fuel', val)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.inputCell}
        value={weightData[section].load}
        onChangeText={val => handleChange(section, 'load', val)}
        keyboardType="numeric"
      />
      <TextInput
        style={styles.inputCell}
        value={weightData[section].tWeight}
        onChangeText={val => handleChange(section, 'tWeight', val)}
        keyboardType="numeric"
      />
    </View>
  );
